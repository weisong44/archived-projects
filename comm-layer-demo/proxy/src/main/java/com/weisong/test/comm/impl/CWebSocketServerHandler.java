...
import com.weisong.test.comm.impl.CBaseWebSocketProxy.WebSocketEndpointRemote;
import com.weisong.test.comm.pdu.CPdu;

public class CWebSocketServerHandler extends SimpleChannelInboundHandler<Object> {

    static private final String WEBSOCKET_PATH = "/proxy";
    ...
    private void handleWebSocketFrame(ChannelHandlerContext ctx, WebSocketFrame frame) {
        ...
        if(pdu.isNotification()) {
        	WebSocketEndpointRemote epRemote = new WebSocketEndpointRemote(
        			pdu.srcAddr, ctx);
