...
public class TestReverseSelectionSystemFilter extends BaseUnitTest {
	...
	public void testFilter() throws Exception {
		...
		SystemFilterChain chain = new SystemFilterChain(
			createNetProfitSystemFilter1(),
		  	createReverseSelectionFilter()
		);
		...
		for(YearAndMonth ym = ym1; !ym.after(ym2); ym = YearAndMonth.inc(ym)) {
			...
			if(i < expectedSelectionDate.length) {
